    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="icon" name="icon" value="{{ $brandlist->icon }}"    />
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea type="text" class="form-control" id="point1" name="point1"  >{{ $brandlist->point1 }}  </textarea>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea type="text" class="form-control" id="point2" name="point2"  >{{ $brandlist->point2 }} </textarea>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-sm-10">
              <textarea type="text" class="form-control" id="point3" name="point3" >{{ $brandlist->point3 }}</textarea>
            </div>
          </div>
